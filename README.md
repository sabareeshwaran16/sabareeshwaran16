...
<p align="center">
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:0F172A,100:0EA5E9&height=4"/>
</p>
...
🌟 Passionate about building intelligent AI-powered systems  

💻 Full Stack Developer focused on scalable backend applications  

⚡ Interested in AI, System Design & Real-time Applications  

🌱 Currently learning Cloud, DevOps & Advanced DSA  

🏆 Hackathon Winner & Competitive Programmer  

🔬 Love combining AI + Hardware + Software together  
...
<img src="https://skillicons.dev/icons?i=docker,vercel,render,netlify,gcp"/>
...
## 🧠 [NEOGUARD – NICU Intelligent Monitoring System](https://github.com/sabareeshwaran16/NeoGaurd)

📅 2026

### ⚙️ Tech Stack
`ESP32` `MAX30102` `DS18B20` `Python` `FastAPI` `WebSockets` `React` `Telegram API`

- Integrated ESP32 with biomedical sensors
- Captured neonatal vital signs in real-time
- Streamed live data to backend pipeline
- Supported anomaly detection & emergency alerts
- Worked on hardware interfacing & transmission layer

---

## 🏫 [DIGITAL EXAM HALL ALLOCATION & CONTROL SYSTEM](https://github.com/sabareeshwaran16/Hall-management)

📅 2025

### ⚙️ Tech Stack
`MongoDB` `Express.js` `React.js` `Node.js` `JWT` `PDFKit`

- Developed MERN stack hall allocation platform
- Implemented role-based authentication
- Automated seating & hall allocation
- Added hall ticket generation system
- Built admin, faculty & student modules

---

## 🔥 [FIRE & SMOKE DETECTION](https://github.com/sabareeshwaran16/firedetection_final.git)

📅 2025

### ⚙️ Tech Stack
`Python` `YOLOv8` `OpenCV` `Django` `JavaScript`

- Developed AI-powered fire detection system
- Trained YOLOv8 detection models
- Processed real-time camera streams
- Built backend APIs & monitoring dashboard
- Added responsive real-time alert interface
...
<tr>
<td align="center">
<img src="https://skillicons.dev/icons?i=leetcode" width="45"/><br>

<b>LeetCode</b><br>
Solved 301+ Problems<br>
32+ Contests<br>
Rank: 508,329<br><br>

<a href="https://leetcode.com/u/_Sabareeshwaran_B/">
Profile Link
</a>
...
<td align="center">
<img src="https://skillicons.dev/icons?i=hackerrank" width="45"/><br>
...
<a href="https://www.hackerrank.com/profile/sabareeshwaran41">
Profile Link
</a>
...
<td align="center">
<img src="https://img.icons8.com/color/96/trophy.png" width="45"/><br>
...
<a href="https://www.skillrack.com/faces/resume.xhtml?id=515320&key=3dc237a515194b5aa23b2bad9b4e842ee7e7c6f3">
Profile Link
</a>
...
| 🏅 Achievement | 📅 Year |
|---|---|
| 🥇 Won First Place in Mini Project Expo – Sri Eshwar College of Engineering | 2026 |
| 🏆 Winners of Anokha’26 Process Warzone – ₹20,000 Cash Prize | 2026 |
| 🚀 7th Place – Technovation Hackathon, Kurukshetra, Anna University | 2026 |
| ⭐ Shortlisted in HackWithUttarPradesh – Top 300 Teams Across India | 2025 |
...
<img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=sabareeshwaran16&theme=github_dark"/>
